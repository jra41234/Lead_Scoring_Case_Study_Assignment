...
- Lead_Scoring Case Study_Assignment.ipynb : The python file showing coding and data analysis
- Assignment Subjective Questions_Answers.pdf : Some subjective questions answered
- Lead_Scoring_case_study_presentation.pdf : Final Presentation
- Leads.csv : Data worked on
- Leads Data Dictionary.xlsx : Data Dictionary
- Lead score case study report.pdf : Summary on what's done in the entire py file
